...
(1,'Ângela Magalhães','angela_magalhaes','Estudante de EngComp / Bolsista DTI / Tec Redes Comp','angelam@alu.ufc.br','(88) 9 9920-3298','lattes.cnpq.br/7366228102006177','Possui curso técnico em Redes de Computadores realizado no período de 2011-2014 na Escola Estadual de Educação Profissional Francisca Maura Martins - Hidrolândia-Ce. Cursando o 6º (sexto) semestre de Engenharia da Computação pela Universidade Federal do Ceará (UFC) - campus Sobral. Possui interesse em <i>Machine Learning</i>, e em cursar Matemática futuramente.'),
